...
'''
1) I would build a program that allows you to create emojis that describe exactly how you are feeling by a description. You would have a little search bar that you can put in descriptive words, and then an emoji would be generated to fit the descriptive words.
